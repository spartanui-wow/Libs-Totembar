...
Libs-Totembar is a revolutionary WoW addon that breaks the traditional "totem bar" limitations. Want to track your Shaman totems? ✅ Hunter traps? ✅ Priest feathers? ✅ **Any spell from any class?** ✅
...
*More classes and abilities can be added upon request.*
...
When SpartanUI is installed, Libs-Totembar will use SUI's logging system for debug output and enhanced integration. This is completely optional - the addon works fine without SpartanUI.
